...
function ruleFunction(primaryOption, secondaryOptionObject) {
    const options = Array.isArray(primaryOption) ? primaryOption : [primaryOption]

    const ignores = secondaryOptionObject.ignores || [];
    ...
    return function (postcssRoot, postcssResult) {
        for (const option of options) {
            ...
            const validOptions = stylelint.utils.validateOptions(postcssResult,
                ruleName, {
                    actual: option,
